...
salaries <- data.frame(employees, starting_salaries, salary_adjustments, stringsAsFactors = FALSE)

# Add a column to the `salaries` data frame that represents each person's
# salary in 2018 (e.g., with the salary adjustment added in).
salaries$salaries_2018 <- salaries$starting_salaries + salaries$salary_adjustments 
...
## Yes, I expected the means to be around $2500 and -$2500, the middle of the 2 ranges
##  we are measuring. Both answers were close to this.
