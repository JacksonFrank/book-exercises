...
print(is.list(data)) # It return a list

# Manually inspect the returned data and identify the content of interest 
# (which are the movie reviews).
# Use functions such as `names()`, `str()`, etc.
print(names(data))
print(str(data)) # the results key in the list points to the content of interest
...
most_recent_review <- head(reviews, 1) #Reviews already ordered by date from most recent
